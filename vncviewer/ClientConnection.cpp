...
//
//  callback function that displays windows that display remote pc display
//
...
//					if (GetFocus() != _this->m_hwnd) return 0;
            ...
            case WM_INTPUTLANGCHANGE:
                {
                    ActivateKeyboardLayout(m_options.m_kbdname, KLF_REPLACELANG | KLF_REORDER);
                    return 0;
                }
